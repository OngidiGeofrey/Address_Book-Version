...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO cities (City_Code, City_Name) VALUES (%s, %s)",
...
<table width="100%" border="0">
  <tr>
    <td><center>
    <fieldset> <legend style="margin-left:50%">Enter City details</legend>
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">City Code:</td>
            <td><input type="text" name="City_Code" value="" size="32" required /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">City Name:</td>
            <td><input type="text" name="City_Name" value="" size="32"  required/></td>
          </tr>
          <tr valign="baseline">
