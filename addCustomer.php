      ...
      <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
        <table align="center">
          ...
          <tr valign="baseline">
            ...
            <td><input type="text" name="Email_address" value="" size="32" required /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Street:</td>
            <td><input type="text" name="street" value="" size="32" required /></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">Zip Code:</td>
            <td><input type="text" name="Zip_code" value="" size="32" required/></td>
          </tr>
          <tr valign="baseline">
            <td nowrap="nowrap" align="right">City :</td>
            <td><select name="City_Code" style="width:261px" required>
              <?php
do {  
?>
           ...
           <tr>
             ...
             <td><?php echo $row_Recordset1['City_Code']; ?></td>
              <td>
               ...
               <button style="background-color:light-blue; text-decoration:none"><a href="updateCustomer.php? id=<?php echo $row_Recordset1['Email_address']; ?>" class=                 "text-light">Update</a></button><br><br>
